...
import { Sparkles, BotMessageSquare, DatabaseZap, CalendarPlus, FileText, ChevronRight, MessageSquare, Activity, ShieldCheck, TrendingUp, BrainCircuit } from 'lucide-react';
import Header from "@/components/layout/Header";
import Footer from "@/components/layout/Footer";

export const metadata: Metadata = {
  title: 'Healthsyntra: AI Symptom Analysis & Health Tracking',
  description: 'Discover Healthsyntra: Get instant AI-driven insights on your symptoms, track health records, and schedule medical appointments. Your personal health companion.',
  openGraph: {
    title: 'Healthsyntra: AI Symptom Analysis & Health Tracking',
    ...
    images: [
      {
        url: '/Healthsyntra.jpg',
        width: 1200,
        height: 600,
        alt: 'Healthsyntra Dashboard Mockup',
      },
    ],
  },
  twitter: {
...
const testimonials = [
  {
    quote: "Healthsyntra helped me understand my symptoms quickly and gave me peace of mind. The appointment scheduling was a breeze!",
    name: "Sarah L.",
  ...
  {
    quote: "I was hesitant about AI in healthcare, but Healthsyntra is user-friendly and provides genuinely helpful insights. Highly recommend!",
    name: "Maria K.",
    role: "Tech Skeptic",
    avatar: "https://placehold.co/100x100.png",
    dataAiHint: "person portrait"
          ...
          <div className="container mx-auto px-6 text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-10">
                Get personalized insights, track your health journey, and schedule appointments seamlessly. Healthsyntra is your intelligent health companion.
              </p>
            ...
            <div className="mt-16">
              <Image
                src="/Healthsyntra.jpg"
                alt="Healthsyntra Dashboard showing symptom analysis and health tracking features"
                width={1200}
                height={600}
        ...
        <section id="features" className="py-16 md:py-24 bg-secondary/20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight">Why Choose Healthsyntra?</h2>
        ...
        <section id="how-it-works" className="py-16 md:py-24">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground mt-4 max-w-2xl mx-auto">
                Getting started with Healthsyntra is quick and easy. Follow these simple steps:
              </p>
            </div>
        ...
        <section id="testimonials" className="py-16 md:py-24 bg-primary/5">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground mt-4 max-w-2xl mx-auto">
                Don't just take our word for it. Here's what our users are saying about Healthsyntra.
              </p>
            </div>
        ...
        <section id="pricing" className="py-16 md:py-24 bg-secondary/20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground mt-4 max-w-2xl mx-auto">
                Choose a plan that fits your needs. Start for free and upgrade as you go.
              </p>
            </div>
            <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {/* Free Plan */}
              <Card className="flex flex-col text-center shadow-md hover:shadow-lg transition-shadow">
                <CardHeader>
                  <CardTitle className="text-2xl">Free</CardTitle>
                  <CardDescription>Get started with basic analysis.</CardDescription>
                </CardHeader>
                <CardContent className="flex-grow">
                  <p className="text-4xl font-bold mb-4">$0<span className="text-lg text-muted-foreground font-medium">/mo</span></p>
                  <p className="text-muted-foreground">1 AI analysis per month</p>
                </CardContent>
                <CardFooter>
              ...
              {/* Standard Plan */}
              <Card className="flex flex-col text-center shadow-lg hover:shadow-xl transition-shadow border-2 border-primary">
                <CardHeader>
                  <CardTitle className="text-2xl">Standard</CardTitle>
                  <CardDescription>For proactive health tracking.</CardDescription>
                </CardHeader>
                <CardContent className="flex-grow">
                  <p className="text-4xl font-bold mb-4">$9.99<span className="text-lg text-muted-foreground font-medium">/mo</span></p>
                  <p className="text-muted-foreground">Save history & schedule appointments</p>
                </CardContent>
                <CardFooter>
              ...
              <Card className="flex flex-col text-center shadow-md hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <CardDescription>Unlimited access and insights.</CardDescription>
                </CardHeader>
                <CardContent className="flex-grow">
                  <p className="text-4xl font-bold mb-4">$19.99<span className="text-lg text-muted-foreground font-medium">/mo</span></p>
                  <p className="text-muted-foreground">Unlimited analyses & priority support</p>
                </CardContent>
                <CardFooter>
                  <Button asChild variant="outline" className="w-full">
                    <Link href="/pricing">Learn More</Link>
        ...
        <section className="py-20 md:py-32 text-center bg-gradient-to-t from-primary/10 to-background">
          <div className="container mx-auto px-6">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              Join thousands of users who are gaining valuable health insights with Healthsyntra. It's fast, secure, and designed for you.
            </p>
