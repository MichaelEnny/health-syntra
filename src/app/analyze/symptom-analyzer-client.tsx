...
import { AlertCircle, CalendarClock, ClipboardList, FlaskConical, Lightbulb, Loader2, Stethoscope, ShieldAlert, AlertTriangle, ShieldCheck, ShieldQuestion, Info, MessageCircleQuestion, CalendarPlus, UserPlus } from 'lucide-react';
...
export default function SymptomAnalyzerClient() {
    ...
    try {
      ...
      if (currentUser) {
        ...
        toast({
          ...
          description: "Your health record has been saved to your dashboard.",
        });
  ...
  const handleScheduleAppointment = async () => {
    ...
    try {
        ...
        toast({
            ...
            description: "Could not save your appointment to the database. Please try again."
        });
    }
  };
  ...
  const GuestPrompt = () => (
      <Card className="shadow-xl animate-in fade-in-50 duration-1000 bg-primary/10 border-primary/20">
        <CardHeader>
          <CardTitle className="text-xl flex items-center">
            <UserPlus className="mr-2 h-7 w-7 text-primary" /> Unlock Full Features
          </CardTitle>
          <CardDescription>Create a free account to save your health history and schedule appointments.</CardDescription>
        </CardHeader>
        <CardContent>
          <ul className="list-disc list-inside space-y-2 text-muted-foreground">
            <li>Save this analysis to your personal dashboard.</li>
            <li>Track your health trends over time.</li>
            <li>Schedule follow-up appointments seamlessly.</li>
        ...
        <CardFooter className="flex flex-wrap gap-4">
          ...
          <Button asChild variant="outline" size="lg" className="flex-grow sm:flex-grow-0">
  ...
  return (
    <div className="space-y-8">
      ...
      {showAppointmentScheduler && currentUser && !isLoading && (
      ...
      {showGuestPrompt && !currentUser && !isLoading && (
        <GuestPrompt />
      )}
    </div>
  );
