...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert medical AI assistant. Your task is to analyze a patient's health history, provided as a JSON string of past records. Provide a concise, professional summary that highlights:
...
Synthesize the information into actionable insights. Your response MUST be a JSON object with a single key "summary" containing the text summary.
